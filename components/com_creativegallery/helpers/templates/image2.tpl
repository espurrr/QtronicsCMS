<div class="image-wrapper">
    <li class="visible {LI_CLASS}">
        <div class="creative-gallery-image-main-wrapper">
            <div class="creative-gallery-image-wrapper">
                <img data-tags="{IMAGE_TAGS}"
                     src="{IMAGE_SRC}"
                     data-path="{IMAGE_PATH}"
                     data-link="{IMAGE_LINK}"
                     data-target="{IMAGE_TARGET}"
                     data-description="{IMG_DESCRIPTION}"
                     data-thumbnail="{IMG_THUMBNAIL}"
                     alt="{IMAGE_ALT}"
                     title="{IMAGE_TITLE}"
                     class="{IMG_CLASS}"
                >
                <div class="overlay"></div>
                <div class="creative-gallery-icons-wrapper">
                    <div class="creative-gallery-icon creative-gallery-icon-zoom"></div>
                    <div class="creative-gallery-icon creative-gallery-icon-link"></div>
                </div>
    ...
    <span class="creative-gallery-text">{IMG_DESCRIPTION}</span>
    <div class="cg_clear"></div>
