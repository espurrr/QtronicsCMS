...
class MoConstants
{
	...
	const MOV_VERSION           = '3.2.38';
	//const MOV_DIR               = plugin_dir_path(__FILE__);
	//const MOV_URL               = plugin_dir_url(__FILE__);
	//const MOV_CSS_URL			= DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR . 'user'.   DIRECTORY_SEPARATOR . 'miniorangesendotp'. DIRECTORY_SEPARATOR . 'media' . DIRECTORY_SEPARATOR . 'css' . DIRECTORY_SEPARATOR . ' mo_customer_validation_style.min.css' ;
	const MOV_CSS_URL	= "miniorangesendotp/media/css/mo_customer_validation_style.min.css";
	
	const MO_TEST_MODE          = False; /*TRUE;*/
    const MO_FAIL_MODE          = False; /*TRUE;*/

    const Joomla_REG			='Joomla_user_registration';
}
new MoConstants;
//DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR . 'user'. 