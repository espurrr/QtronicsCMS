...
class MocURLOTP
{
    ...
    public static function mo_send_otp_token($auth_type, $email = '', $phone = '')
    {
        ...
        $customerKey = !MoUtility::isBlank($customer_details['customer_key'])
            ? $customer_details['customer_key'] : MoConstants::DEFAULT_CUSTOMER_KEY;
        $apiKey = !MoUtility::isBlank($customer_details['api_key'])
            ? $customer_details['api_key'] : MoConstants::DEFAULT_API_KEY;
