...
<?php foreach ($this->items as $i => $item): ?>
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="nowrap">
			<div class="name">
				<?php if ($canDo->get('component_plugins.edit')): ?>
					...
					<?php if ($item->checked_out): ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $userChkOut->name, $item->checked_out_time, 'components_plugins.', $canCheckin); ?>
					<?php endif; ?>
				<?php else: ?>
		...
		<?php if ($canDo->get('component_plugins.edit.state')) : ?>
				<?php if ($item->checked_out) : ?>
					<?php if ($canCheckin) : ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'components_plugins.', true, 'cb'); ?>
					<?php else: ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'components_plugins.', false, 'cb'); ?>
					<?php endif; ?>
				<?php else: ?>
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'components_plugins.', true, 'cb'); ?>
				<?php endif; ?>
