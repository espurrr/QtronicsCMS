...
--ALTER TABLE `#__miniorange_otp_customer` ADD COLUMN `enable_during_login` int(1) NOT NULL;
...
--ALTER TABLE `#__miniorange_otp_customer` ADD COLUMN `log_restriction` VARCHAR(255) NOT NULL;
ALTER TABLE `#__miniorange_otp_customer` ADD COLUMN `white_or_black` VARCHAR(255) NOT NULL;
--ALTER TABLE `#__miniorange_otp_customer` ADD COLUMN `otp_bypass` int(1) NOT NULL;
