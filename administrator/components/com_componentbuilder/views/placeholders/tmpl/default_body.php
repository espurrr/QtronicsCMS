...
<?php foreach ($this->items as $i => $item): ?>
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<?php if ($canDo->get('placeholder.edit')): ?>
		...
		<td class="nowrap">
			<div class="name">
				<?php if ($canDo->get('placeholder.edit')): ?>
					...
					<?php if ($item->checked_out): ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $userChkOut->name, $item->checked_out_time, 'placeholders.', $canCheckin); ?>
					<?php endif; ?>
				<?php else: ?>
		...
		<?php if ($canDo->get('placeholder.edit.state')) : ?>
				<?php if ($item->checked_out) : ?>
					<?php if ($canCheckin) : ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'placeholders.', true, 'cb'); ?>
					<?php else: ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'placeholders.', false, 'cb'); ?>
					<?php endif; ?>
				<?php else: ?>
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'placeholders.', true, 'cb'); ?>
				<?php endif; ?>
